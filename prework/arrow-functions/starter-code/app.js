...
var Students = (name,age,hometown)=>({
  name : name,
  age : age,
 hometown :hometown,

});
var joe = Students('Joe', 100,'Schmoe'); // Ayoub i switched value btw hometown and age
...
// value of joe parameters .
// 2. What is "this" when joe.scopeArrow() is invoked?
// window object .
// 3. Explain why "this" is different when an arrow function is used.
//  using "this" in arrow fun it will be return to window object not like traditional function
